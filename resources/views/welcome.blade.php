    ...
    <body class= "fondo">
            ...
            <div class="container container--flex">
                ...
                <ul class="menu" id="menu">
                    @if (Route::has('login'))
                        ...
                        <li class="menu__item"><a href="{{ url('/home') }}" class="menu__link menu__link">Ideas innovadoras</a></li>
                ...
                <div class="social-icon">
                    <!--Icono de Facebook
                    <a href="https://www.facebook.com" class="social-icon__link"><i class="fab fa-facebook-f"></i></a>
                   -->
                    <!--Icono de Twiter
                    <a href="https://twitter.com/home?lang=es" class="social-icon__link"><i class="fab fa-twitter"></i></a>
                    -->
                   
                    <!--Icono de Mail-->
                    <a href="https://www.google.com/intl/es-419/gmail/about/" class="social-icon__link"><i class="fas fa-envelope"></i></a>
                </div>
            </div>
        </nav>
        <section class="banner">
            <img src="https://niubox.legal/wp-content/uploads/2019/04/Recurso-8innovacion.png" class="banner__img" alt="Responsive image">
            <div class="banner__content" >InnoGenius </div>
        </section>   
        <!-- Publica -->
      ...
      <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-7">
                    <h2 class="TituloServicio">Ideas destacadas</h2>
                </div>
            </div>   
            <div class="row justify-content-center text-center">
