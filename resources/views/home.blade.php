...
@section('content_header')
    <h1 class="m-0 text-dark">Ideas innovadoras</h1>
    @if($busqueda ?? '')
    ...
    <table class="table table-light table-hover text-center text-middle">
        <thead class="thead-light">
            <tr>
                ...
                <th>Encargado del proyecto  <i class="fas fa-user"></i></th>
                <th>Donativo<i class="fas fa-hand-holding-usd"></i></th>
...
<script>
 Swal.fire(
  '¡Bienvenido a InnoGenius!',
  'Publica y da conocer tus ideas innovadoras :D',
  'success'
)
 </script>
 @stop