                ...
                <div class = "card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#servof" data-toggle="tab">Donativos recibidos</a></li>
                            <li class="nav-item"><a class="nav-link" href="#servre" data-toggle="tab">Donativos realizados</a></li>
                    ...
                    <div class="tab-content">
                                  ...
                                  <div class="col-12">
                                    <div class="card">
                                      <div class="card-header">
                                        <h3 class="card-title">Donativos que recibiste</h3>
                            ...
                            <div class="post">
                                ...
                                <div class="row">
                                  <div class="col-12">
                                    <div class="card">
                                      <div class="card-header">
                                        <h3 class="card-title">Donativos realizados</h3>
                            ...
                            <div class="btn-group">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body">
                                      ...
                                      jarplickers sifteo edmodo ifttt zimbra. Babblely odeo kaboodle
                        ...
                        <div class="tab-pane" id="settings">
                            <form method="POST" action="{{ route('profile.update') }}">
                                ...
                                <div class="form-group row">
                                    <label for="profession" class="col-md-2 col-form-label text-md-right">Trabajo</label>
