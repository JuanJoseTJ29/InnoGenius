...
class ServiciosController extends Controller
{
    ...
    return redirect('servicios')->with('Mensaje','Idea registrada con éxito');
     }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('servicios')->with('Mensaje','Idea modificada');
    }
    ...
    return redirect('servicios')->with('Mensaje','Idea eliminada');
    }
